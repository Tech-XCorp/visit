...
struct vtkPositionLabelMapper2DPrivate
{
    ...
    vtkPositionLabelMapper2DPrivate()
    {
        widget = 0;
        bestRenderer = -1;
        overlay = 0;
    ...
    vtkPositionLabelMapper2DPrivate(const vtkPositionLabelMapper2DPrivate &obj)
    {
        widget = obj.widget;
    ...
    void operator = (const vtkPositionLabelMapper2DPrivate &obj)
    {
        widget = obj.widget;
        bestRenderer = obj.bestRenderer;
        overlay = 0;
...
vtkStandardNewMacro(vtkPositionLabelMapper2D);

// ****************************************************************************
// Method: vtkPositionLabelMapper2D::vtkPositionLabelMapper2D
//
// Purpose:
//   Constructor.
//
...
vtkPositionLabelMapper2D::vtkPositionLabelMapper2D() : vtkPolyDataMapper2D()
{
    privateInstance = new vtkPositionLabelMapper2DPrivate;
}
...
vtkPositionLabelMapper2D::~vtkPositionLabelMapper2D()
{
...
// ****************************************************************************
// Method: vtkPositionLabelMapper2D::ReleaseGraphicsResources
//
// Purpose:
...
void
vtkPositionLabelMapper2D::ReleaseGraphicsResources(vtkWindow *win)
{
...
// ****************************************************************************
// Method: vtkPositionLabelMapper2D::SetWidget
//
// Purpose:
...
void
vtkPositionLabelMapper2D::SetWidget(QWidget *w)
{
    privateInstance->widget = w;
}

// ****************************************************************************
// Method: vtkPositionLabelMapper2D::RenderOverlay
//
// Purpose:
...
void
vtkPositionLabelMapper2D::RenderOverlay(vtkViewport* viewport, vtkActor2D* actor)
{
...
void
vtkPositionLabelMapper2D::RenderOverlay_Qt(vtkViewport* viewport, vtkActor2D* actor)
{
