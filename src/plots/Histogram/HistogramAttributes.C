...
//
// Enum conversion methods for HistogramAttributes::LimitsMode
//
...
std::string
HistogramAttributes::LimitsMode_ToString(HistogramAttributes::LimitsMode t)
{
    int index = int(t);
    if(index < 0 || index >= 2) index = 0;
...
std::string
HistogramAttributes::LimitsMode_ToString(int t)
{
    int index = (t < 0 || t >= 2) ? 0 : t;
    return LimitsMode_strings[index];
}
...
bool
HistogramAttributes::LimitsMode_FromString(const std::string &s, HistogramAttributes::LimitsMode &val)
{
    val = HistogramAttributes::OriginalData;
    for(int i = 0; i < 2; ++i)
    {
...
//
// Purpose:
//   Init utility for the HistogramAttributes class.
//
...
//
// Purpose:
//   Copy utility for the HistogramAttributes class.
//
// Note:       Autogenerated by xml2atts.
//
// Programmer: xml2atts
...
void HistogramAttributes::Copy(const HistogramAttributes &obj)
{
    basedOn = obj.basedOn;
    ...
    max = obj.max;
    numBins = obj.numBins;
    useFrequencyVariable = obj.useFrequencyVariable;
    frequencyVariable = obj.frequencyVariable;
    domain = obj.domain;
    zone = obj.zone;
...
const char *HistogramAttributes::TypeMapFormatString = HISTOGRAMATTRIBUTES_TMFS;
const AttributeGroup::private_tmfs_t HistogramAttributes::TmfsStruct = {HISTOGRAMATTRIBUTES_TMFS};
...
//
// Purpose:
//   Default constructor for the HistogramAttributes class.
//
// Note:       Autogenerated by xml2atts.
//
// Programmer: xml2atts
...
HistogramAttributes::HistogramAttributes() :
    ...
    weightVariable("default"), frequencyVariable("default"),
    color(200, 80, 40)
{
    HistogramAttributes::Init();
}
...
//
// Purpose:
//   Constructor for the derived classes of HistogramAttributes class.
//
// Note:       Autogenerated by xml2atts.
//
// Programmer: xml2atts
...
HistogramAttributes::HistogramAttributes(private_tmfs_t tmfs) :
...
//
// Purpose:
//   Copy constructor for derived classes of the HistogramAttributes class.
//
// Note:       Autogenerated by xml2atts.
//
// Programmer: xml2atts
...
HistogramAttributes::HistogramAttributes(const HistogramAttributes &obj, private_tmfs_t tmfs) :
    AttributeSubject(tmfs.tmfs)
{
    HistogramAttributes::Copy(obj);
}
...
HistogramAttributes::SelectAll()
{
    ...
    Select(ID_useFrequencyVariable, (void *)&useFrequencyVariable);
    Select(ID_frequencyVariable,    (void *)&frequencyVariable);
...
HistogramAttributes::CreateNode(DataNode *parentNode, bool completeSave, bool forceAdd)
{
    ...
    if(completeSave || !FieldsEqual(ID_useFrequencyVariable, &defaultObject))
    {
        addToParent = true;
        node->AddNode(new DataNode("useFrequencyVariable", useFrequencyVariable));
    }

    if(completeSave || !FieldsEqual(ID_frequencyVariable, &defaultObject))
    {
        addToParent = true;
        node->AddNode(new DataNode("frequencyVariable", frequencyVariable));
    }
...
HistogramAttributes::SetFromNode(DataNode *parentNode)
{
    ...
    if((node = searchNode->GetNode("useFrequencyVariable")) != 0)
        SetUseFrequencyVariable(node->AsBool());
    if((node = searchNode->GetNode("frequencyVariable")) != 0)
        SetFrequencyVariable(node->AsString());
...
void
HistogramAttributes::SetLimitsMode(HistogramAttributes::LimitsMode limitsMode_)
{
...
void
HistogramAttributes::SetMinFlag(bool minFlag_)
{
    minFlag = minFlag_;
    Select(ID_minFlag, (void *)&minFlag);
}
...
void
HistogramAttributes::SetMaxFlag(bool maxFlag_)
{
    maxFlag = maxFlag_;
    Select(ID_maxFlag, (void *)&maxFlag);
}
...
void
HistogramAttributes::SetUseFrequencyVariable(bool useFrequencyVariable_)
{
    useFrequencyVariable = useFrequencyVariable_;
    Select(ID_useFrequencyVariable, (void *)&useFrequencyVariable);
}

void
HistogramAttributes::SetFrequencyVariable(const std::string &frequencyVariable_)
{
    frequencyVariable = frequencyVariable_;
    Select(ID_frequencyVariable, (void *)&frequencyVariable);
}
...
HistogramAttributes::LimitsMode
HistogramAttributes::GetLimitsMode() const
{
    return LimitsMode(limitsMode);
}

bool
HistogramAttributes::GetMinFlag() const
{
    return minFlag;
}

bool
HistogramAttributes::GetMaxFlag() const
{
    return maxFlag;
}
...
bool
HistogramAttributes::GetUseFrequencyVariable() const
{
    return useFrequencyVariable;
}

const std::string &
HistogramAttributes::GetFrequencyVariable() const
{
    return frequencyVariable;
}

std::string &
HistogramAttributes::GetFrequencyVariable()
{
    return frequencyVariable;
}
...
void
HistogramAttributes::SelectFrequencyVariable()
{
    Select(ID_frequencyVariable, (void *)&frequencyVariable);
}
...
HistogramAttributes::GetFieldName(int index) const
{
    ...
    case ID_useFrequencyVariable: return "useFrequencyVariable";
    case ID_frequencyVariable:    return "frequencyVariable";
...
HistogramAttributes::GetFieldType(int index) const
{
    ...
    case ID_useFrequencyVariable: return FieldType_bool;
    case ID_frequencyVariable:    return FieldType_variablename;
...
HistogramAttributes::GetFieldTypeName(int index) const
{
    ...
    case ID_useFrequencyVariable: return "bool";
    case ID_frequencyVariable:    return "variablename";
...
HistogramAttributes::FieldsEqual(int index_, const AttributeGroup *rhs) const
{
    ...
    case ID_numBins:
        ...
        break;
    case ID_useFrequencyVariable:
        {  // new scope
        retval = (useFrequencyVariable == obj.useFrequencyVariable);
        }
        break;
    case ID_frequencyVariable:
        {  // new scope
        retval = (frequencyVariable == obj.frequencyVariable);
        }
        break;
    case ID_domain:
        {  // new scope
